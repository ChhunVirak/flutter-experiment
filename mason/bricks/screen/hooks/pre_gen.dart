...
void run(HookContext context) {
  ...
  ///GEN Screen
  final moduleFilePath = '${Directory.current.path}/lib/modules';

  final module = Directory(moduleFilePath)..createSync(recursive: true);
...
''';
  ...
  final importContent =
      '''import '../../modules/${context.vars['module']}/screen/${screenName.snakeCase}_screen.dart';''';
